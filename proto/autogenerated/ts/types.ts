...
export type SendAppUserToTwoAppUsersPayment_Query = {
}
export type SendAppUserToTwoAppUsersPayment_RouteParams = {
}
export type SendAppUserToTwoAppUsersPayment_Context = SendAppUserToTwoAppUsersPayment_Query & SendAppUserToTwoAppUsersPayment_RouteParams & AppContext
...
export type ServerMethods = {
    ...
    AddApp?: (ctx: AddApp_Context, req: AuthAppRequest) => Promise<AuthApp>
    ...
    SendAppUserToTwoAppUsersPayment?: (ctx: SendAppUserToTwoAppUsersPayment_Context, req: SendAppUserToTwoAppUsersPaymentRequest) => Promise<void>
...
export type SendAppUserToTwoAppUsersPaymentRequest = {
    from_user_identifier: string
    to_user_identifier_1: string
    to_user_identifier_2: string
    amount: number
}
export const SendAppUserToTwoAppUsersPaymentRequestOptionalFields: [] = []
export type SendAppUserToTwoAppUsersPaymentRequestOptions = OptionsBaseMessage & {
    checkOptionalsAreSet?: []
    from_user_identifier_CustomCheck?: (v: string) => boolean
    to_user_identifier_1_CustomCheck?: (v: string) => boolean
    to_user_identifier_2_CustomCheck?: (v: string) => boolean
    amount_CustomCheck?: (v: number) => boolean
}
export const SendAppUserToTwoAppUsersPaymentRequestValidate = (o?: SendAppUserToTwoAppUsersPaymentRequest, opts: SendAppUserToTwoAppUsersPaymentRequestOptions = {}, path: string = 'SendAppUserToTwoAppUsersPaymentRequest::root.'): Error | null => {
    if (opts.checkOptionalsAreSet && opts.allOptionalsAreSet) return new Error(path + ': only one of checkOptionalsAreSet or allOptionalNonDefault can be set for each message')
    if (typeof o !== 'object' || o === null) return new Error(path + ': object is not an instance of an object or is null')
    ...
    if (typeof o.to_user_identifier_1 !== 'string') return new Error(`${path}.to_user_identifier_1: is not a string`)
    if (opts.to_user_identifier_1_CustomCheck && !opts.to_user_identifier_1_CustomCheck(o.to_user_identifier_1)) return new Error(`${path}.to_user_identifier_1: custom check failed`)

    if (typeof o.to_user_identifier_2 !== 'string') return new Error(`${path}.to_user_identifier_2: is not a string`)
    if (opts.to_user_identifier_2_CustomCheck && !opts.to_user_identifier_2_CustomCheck(o.to_user_identifier_2)) return new Error(`${path}.to_user_identifier_2: custom check failed`)
...
export const AuthAppRequestOptionalFields: [] = []
