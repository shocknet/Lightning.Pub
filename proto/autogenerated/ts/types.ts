...
export type LndMetricsRequestOptionalField = 'to_unix' | 'from_unix'
export const LndMetricsRequestOptionalFields: LndMetricsRequestOptionalField[] = ['to_unix', 'from_unix']
