...
export interface ImportTapscriptResponse {
     ...
     *
     * @generated from protobuf field: string p2tr_address = 1
     */
    p2TrAddress: string;
}
/**
...
export interface PendingSweep {
     ...
     *
     * @generated from protobuf field: uint32 maturity_height = 15
     */
...
export interface BumpFeeRequest {
     ...
     *
     * @generated from protobuf field: uint32 deadline_delta = 8
     */
...
export interface BumpForceCloseFeeRequest {
     ...
     * estimate the starting fee rate for the fee function.
     *
     * @generated from protobuf field: uint32 target_conf = 6
     */
    targetConf: number;
}
/**
...
export interface FundPsbtRequest {
     ...
     * be used.
     *
     * @generated from protobuf field: bytes custom_lock_id = 13
     */
    customLockId: Uint8Array;
    /**
     ...
     *
     * @generated from protobuf field: uint64 lock_expiration_seconds = 14
     */
    lockExpirationSeconds: bigint;
}
/**
...
class ListUnspentResponse$Type extends MessageType<ListUnspentResponse> {
    constructor() {
        super("walletrpc.ListUnspentResponse", [
            { no: 1, name: "utxos", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Utxo }
        ]);
    }
...
class Account$Type extends MessageType<Account> {
    ...
    create(value?: PartialMessage<Account>): Account {
        ...
        message.extendedPublicKey = "";
        message.masterKeyFingerprint = new Uint8Array(0);
        message.derivationPath = "";
        message.externalKeyCount = 0;
        message.internalKeyCount = 0;
        message.watchOnly = false;
        if (value !== undefined)
...
class AccountWithAddresses$Type extends MessageType<AccountWithAddresses> {
    constructor() {
        super("walletrpc.AccountWithAddresses", [
            ...
            { no: 4, name: "addresses", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => AddressProperty }
        ]);
    }
...
class ListAccountsResponse$Type extends MessageType<ListAccountsResponse> {
    constructor() {
        super("walletrpc.ListAccountsResponse", [
            { no: 1, name: "accounts", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Account }
        ]);
    }
...
class RequiredReserveRequest$Type extends MessageType<RequiredReserveRequest> {
    ...
    create(value?: PartialMessage<RequiredReserveRequest>): RequiredReserveRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.additionalPublicChannels = 0;
        if (value !== undefined)
...
class ListAddressesRequest$Type extends MessageType<ListAddressesRequest> {
    ...
    create(value?: PartialMessage<ListAddressesRequest>): ListAddressesRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.accountName = "";
        message.showCustomAccounts = false;
        if (value !== undefined)
...
class ListAddressesResponse$Type extends MessageType<ListAddressesResponse> {
    constructor() {
        super("walletrpc.ListAddressesResponse", [
            { no: 1, name: "account_with_addresses", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => AccountWithAddresses }
        ]);
    }
...
class ImportTapscriptRequest$Type extends MessageType<ImportTapscriptRequest> {
    ...
    create(value?: PartialMessage<ImportTapscriptRequest>): ImportTapscriptRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.internalPublicKey = new Uint8Array(0);
        message.script = { oneofKind: undefined };
        if (value !== undefined)
...
class TapscriptFullTree$Type extends MessageType<TapscriptFullTree> {
    constructor() {
        super("walletrpc.TapscriptFullTree", [
            { no: 1, name: "all_leaves", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TapLeaf }
        ]);
    }
...
class TapscriptPartialReveal$Type extends MessageType<TapscriptPartialReveal> {
    ...
    create(value?: PartialMessage<TapscriptPartialReveal>): TapscriptPartialReveal {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.fullInclusionProof = new Uint8Array(0);
        if (value !== undefined)
...
class Transaction$Type extends MessageType<Transaction> {
    ...
    create(value?: PartialMessage<Transaction>): Transaction {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.txHex = new Uint8Array(0);
        message.label = "";
        if (value !== undefined)
...
class SendOutputsRequest$Type extends MessageType<SendOutputsRequest> {
    constructor() {
        super("walletrpc.SendOutputsRequest", [
            ...
            { no: 2, name: "outputs", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TxOut },
    ...
    create(value?: PartialMessage<SendOutputsRequest>): SendOutputsRequest {
        ...
        message.coinSelectionStrategy = 0;
        if (value !== undefined)
...
class EstimateFeeResponse$Type extends MessageType<EstimateFeeResponse> {
    ...
    create(value?: PartialMessage<EstimateFeeResponse>): EstimateFeeResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.satPerKw = 0n;
        message.minRelayFeeSatPerKw = 0n;
        if (value !== undefined)
...
class PendingSweep$Type extends MessageType<PendingSweep> {
    constructor() {
        super("walletrpc.PendingSweep", [
            ...
            { no: 15, name: "maturity_height", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value?: PartialMessage<PendingSweep>): PendingSweep {
        ...
        message.broadcastAttempts = 0;
        message.nextBroadcastHeight = 0;
        message.force = false;
        message.requestedConfTarget = 0;
        message.requestedSatPerByte = 0;
        message.satPerVbyte = 0n;
        message.requestedSatPerVbyte = 0n;
        message.immediate = false;
        message.budget = 0n;
        message.deadlineHeight = 0;
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint32 deadline_height */ 14:
                    ...
                    break;
                case /* uint32 maturity_height */ 15:
    ...
    internalBinaryWrite(message: PendingSweep, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.maturityHeight !== 0)
            writer.tag(15, WireType.Varint).uint32(message.maturityHeight);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class PendingSweepsResponse$Type extends MessageType<PendingSweepsResponse> {
    constructor() {
        super("walletrpc.PendingSweepsResponse", [
            { no: 1, name: "pending_sweeps", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PendingSweep }
        ]);
    }
...
class BumpFeeRequest$Type extends MessageType<BumpFeeRequest> {
    constructor() {
        super("walletrpc.BumpFeeRequest", [
            ...
            { no: 8, name: "deadline_delta", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    ...
    internalBinaryWrite(message: BumpFeeRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.deadlineDelta !== 0)
            writer.tag(8, WireType.Varint).uint32(message.deadlineDelta);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class BumpForceCloseFeeRequest$Type extends MessageType<BumpForceCloseFeeRequest> {
    constructor() {
        super("walletrpc.BumpForceCloseFeeRequest", [
            ...
            { no: 6, name: "target_conf", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value?: PartialMessage<BumpForceCloseFeeRequest>): BumpForceCloseFeeRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.deadlineDelta = 0;
        message.startingFeerate = 0n;
        message.immediate = false;
        message.budget = 0n;
        message.targetConf = 0;
        if (value !== undefined)
    ...
    internalBinaryWrite(message: BumpForceCloseFeeRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.targetConf !== 0)
            writer.tag(6, WireType.Varint).uint32(message.targetConf);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class ListSweepsResponse$Type extends MessageType<ListSweepsResponse> {
    ...
    create(value?: PartialMessage<ListSweepsResponse>): ListSweepsResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.sweeps = { oneofKind: undefined };
        if (value !== undefined)
...
class FundPsbtRequest$Type extends MessageType<FundPsbtRequest> {
    constructor() {
        super("walletrpc.FundPsbtRequest", [
            ...
            { no: 13, name: "custom_lock_id", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 14, name: "lock_expiration_seconds", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<FundPsbtRequest>): FundPsbtRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.template = { oneofKind: undefined };
        message.fees = { oneofKind: undefined };
        message.account = "";
        message.minConfs = 0;
        message.spendUnconfirmed = false;
        message.changeType = 0;
        message.coinSelectionStrategy = 0;
        message.maxFeeRatio = 0;
        message.customLockId = new Uint8Array(0);
        message.lockExpirationSeconds = 0n;
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* double max_fee_ratio */ 12:
                    ...
                    break;
                case /* bytes custom_lock_id */ 13:
                    message.customLockId = reader.bytes();
                    break;
                case /* uint64 lock_expiration_seconds */ 14:
                    message.lockExpirationSeconds = reader.uint64().toBigInt();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: FundPsbtRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.customLockId.length)
            writer.tag(13, WireType.LengthDelimited).bytes(message.customLockId);
        /* uint64 lock_expiration_seconds = 14; */
        if (message.lockExpirationSeconds !== 0n)
            writer.tag(14, WireType.Varint).uint64(message.lockExpirationSeconds);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class FundPsbtResponse$Type extends MessageType<FundPsbtResponse> {
    constructor() {
        super("walletrpc.FundPsbtResponse", [
            ...
            { no: 3, name: "locked_utxos", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => UtxoLease }
        ]);
    }
    create(value?: PartialMessage<FundPsbtResponse>): FundPsbtResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.fundedPsbt = new Uint8Array(0);
        message.changeOutputIndex = 0;
        message.lockedUtxos = [];
        if (value !== undefined)
...
class TxTemplate$Type extends MessageType<TxTemplate> {
    constructor() {
        super("walletrpc.TxTemplate", [
            { no: 1, name: "inputs", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => OutPoint },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for walletrpc.TxTemplate.outputs");
            }
        }
        map[key ?? ""] = val ?? 0n;
    }
...
class PsbtCoinSelect$Type extends MessageType<PsbtCoinSelect> {
    ...
    create(value?: PartialMessage<PsbtCoinSelect>): PsbtCoinSelect {
        ...
        message.changeOutput = { oneofKind: undefined };
        if (value !== undefined)
...
class SignPsbtResponse$Type extends MessageType<SignPsbtResponse> {
    ...
    create(value?: PartialMessage<SignPsbtResponse>): SignPsbtResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.signedPsbt = new Uint8Array(0);
        message.signedInputs = [];
        if (value !== undefined)
...
class FinalizePsbtResponse$Type extends MessageType<FinalizePsbtResponse> {
    ...
    create(value?: PartialMessage<FinalizePsbtResponse>): FinalizePsbtResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.signedPsbt = new Uint8Array(0);
        message.rawFinalTx = new Uint8Array(0);
        if (value !== undefined)
...
class ListLeasesResponse$Type extends MessageType<ListLeasesResponse> {
    constructor() {
        super("walletrpc.ListLeasesResponse", [
            { no: 1, name: "locked_utxos", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => UtxoLease }
        ]);
    }
