...
export interface Transaction {
     ...
     *
     * @generated from protobuf field: repeated string dest_addresses = 8;
     */
...
export interface PendingChannelsResponse_PendingOpenChannel {
     ...
     *
     * @generated from protobuf field: uint32 confirmation_height = 2;
     */
...
export interface Hop {
     ...
     *
     * @generated from protobuf field: bool tlv_payload = 9;
     */
    tlvPayload: boolean;
    /**
     *
...
class PendingChannelsResponse_PendingOpenChannel$Type extends MessageType<PendingChannelsResponse_PendingOpenChannel> {
    ...
    internalBinaryWrite(message: PendingChannelsResponse_PendingOpenChannel, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.confirmationHeight !== 0)
            writer.tag(2, WireType.Varint).uint32(message.confirmationHeight);
        /* int64 commit_fee = 4; */
        if (message.commitFee !== "0")
