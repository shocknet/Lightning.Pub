...
import { ensureUserBalanceAtLeast, expectThrowsAsync, runSanityCheck, safelySetUserBalance, TestBase } from "./testBase.js"
...
const testConcurrentInvoiceSameLivePaysOnce = async (T: TestBase) => {
    ...
    await ensureUserBalanceAtLeast(T, T.user2, await debitSendCost(T, 500) + 1_000)
