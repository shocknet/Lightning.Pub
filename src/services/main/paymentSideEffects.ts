...
import { encodeClinkResponse } from "../CLINK/clinkTypes.js"
...
export class PaymentSideEffects {
    ...
    async createClinkReceipt(log: PubLogger, invoice: UserReceivingInvoice) {
        ...
        const event = encodeClinkResponse(CLINK_OFFER_KIND, { res: 'ok' }, {
            pub: invoice.clink_requester_pub,
            id: invoice.clink_requester_event_id,
        })
