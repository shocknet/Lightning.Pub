...
import GetClinkMethods from './services/serverMethods/clinkMethods.js'
...
const start = async () => {
    ...
    const clinkMethods = GetClinkMethods(mainHandler)
    ...
    const { Send, Stop, Ping, Reset } = nostrMiddleware(serverMethods, clinkMethods, mainHandler,
        {
